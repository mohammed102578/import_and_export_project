                    ...
                    <table id="files_list" class="table table-striped dt-responsive  "style="width:100%">
                        <thead>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>@lang('site.project_manager') :</center>
                                </td>


                                <td>
                                    <center>@lang('site.HSE') :</center>
                                </td>

                                <td>
                                    <center>@lang('site.Stock') :</center>
                                </td>


                                <td>
                                    <center>@lang('site.Asset') :</center>
                                </td>

                                <td>
                                    <center>@lang('site.IT') :</center>
                                </td>

                                <td>
                                    <center>@lang('site.cost') :</center>
                                </td>

                                @if ($ID == 1)
                                    <td>
                                        <center>@lang('site.cto_manager') :</center>
                                    </td>
                                @else

                                <td>
                                        <center>@lang('site.commerce') :</center>
                                    </td>
                                @endif
                            </tr>
                            <tr>
