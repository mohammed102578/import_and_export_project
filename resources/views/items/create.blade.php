            ...
            <div class="col-sm-6">
                <nav class="breadcrumb-two" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="{{route('items.index',$request_id)}}">@lang('site.items')</a></li>
                        <li class="breadcrumb-item "><a href="{{route('items.create',$request_id)}}">@lang('site.add')</a></li>
                    </ol>
                </nav>
            </div>
            <div class="col-sm-6">
...
{{--        @include('adminlte-templates::common.errors')--}}
        ...
        <div class="card" style="width: 100%;display: block">
            ...
            {!! Form::open(['route' => ['items.store',$request_id], 'files' => true,'class' =>"needs-validation " ,'novalidate']) !!}
