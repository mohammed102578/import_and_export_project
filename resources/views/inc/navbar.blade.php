    ...
    <header class="header navbar navbar-expand-sm expand-header">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            ...
            <li class="nav-item theme-text">
                <a href="{{route('dashboard')}}" class="nav-link"><img src="{{@\App\Models\Setting::first()->logo_path}}" style="max-height: 100px"></a>
            </li>
            ...
            <li class="nav-item align-self-center search-animated">
                ...
                <form class="form-inline search-full form-inline search" role="search">
                    <div class="search-bar">
                        <input type="text" class="form-control search-form-control  ml-lg-auto" id="myInput"
                               onkeyup="myFunction()" aria-controls="html5-extension" placeholder="Search...">
                    </div>
                </form>
            </li>
        </ul>
            ...
            <li class="nav-item dropdown language-dropdown more-dropdown">
                <div class="dropdown  custom-dropdown-icon">
                    <a class="dropdown-toggle btn" href="#" role="button" id="langDropdown" data-toggle="dropdown"
                       aria-haspopup="true"
                       aria-expanded="false">{{app()->getLocale()=='ar'?__('site.arabic'):__('site.english')}}</span>
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                             stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                             class="feather feather-chevron-down">
                            <polyline points="6 9 12 15 18 9"></polyline>
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="langDropdown">
                        <a class="dropdown-item" data-img-value="ar" data-value="arabic"
                           href="{{route('setLanguage','ar')}}">{{__('site.arabic')}}</a>
                        <a class="dropdown-item" data-img-value="en" data-value="english"
                           href="{{route('setLanguage','en')}}">{{__('site.english')}}</a>
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                    ...
                    <div class="dropdown-item">
                        <a href="{{route('users.show',auth()->id())}}">
                            ...
                            <span>@lang('site.my_profile')</span>
                        </a>
                    </div>
