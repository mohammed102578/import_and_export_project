...
<div class="form-group col-sm-4">
	...
	<select class="form-control" name="link_with" id="created_at_ViewBy" onchange="myFunction_created_at()" style="padding: 0;">
...
<div class="form-group col-sm-4">
	...
	<select class="form-control" name="link_with" id="ddlViewBy" onchange="myFunction()" style="padding: 0;">
        ...
        ->where('asset_manager','!=',0)
        ->where('cto_manager','!=',0)
        ->where('project_manager','!=',0)->get() as $role)			@php $id_i = $role->id; @endphp
